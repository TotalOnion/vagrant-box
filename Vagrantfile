...
Vagrant.configure(2) do |config|
  ...
  # sync: folder 'project_folder' (host machine) -> folder '/app' (guest machine)
  ...
  # provisioners
  config.vm.provision 'shell', path: './vagrant/provision/once-as-root.sh', args: [options['timezone'], options['db_name']]
